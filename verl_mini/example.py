"""
Example usage of verl_mini - demonstrating core RLHF/PPO training concepts.
...
from verl_mini import DataProto, BaseConfig
from verl_mini.trainer import (
    PPOConfig,
    PPOTrainer,
    ActorModel,
    CriticModel,
...
from verl_mini.core_algos import AdvantageEstimator
...
def main():
    """Run all examples."""
    print("\n" + "=" * 60)
    print("verl_mini - Simplified RLHF Framework Demo")
    print("=" * 60 + "\n")
