...
\author{\uppercase{Guotong Hu}\authorrefmark{1}, \uppercase{Guangtao Huang}\authorrefmark{1}}
\address[1]{University of Electronic Science and Technology of China (UESTC), Chengdu 611731, China (e-mail: guangtao.huang@uestc.edu.cn)}
...
\markboth
{Hu \MakeLowercase{\textit{et al.}}: ARMOR: A Reliable and Numerically Stable Framework for RL Post-Training of LLMs}
{Hu \MakeLowercase{\textit{et al.}}: ARMOR: A Reliable and Numerically Stable Framework for RL Post-Training of LLMs}

\corresp{Corresponding author: Guangtao Huang (e-mail: guangtao.huang@uestc.edu.cn).}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{author2.png}}]{Guangtao Huang}
received the B.S. degree from the University of Electronic Science and Technology of China (UESTC),
Chengdu, China. His research interests include large language model alignment,
reinforcement learning for NLP, and distributed machine learning systems.
\end{IEEEbiography}
