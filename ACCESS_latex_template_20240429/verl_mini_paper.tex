...
\tfootnote{This work was conducted on 4$\times$NVIDIA H100 80GB HBM3 GPUs. Code is available at \url{https://github.com/hgt0150262/ARMOR}.}
...
import torch   # worker bound to GPU:0
\end{lstlisting}

This ensures each process has exclusive, deterministic access to exactly one GPU.
The binding eliminates cross-GPU resource contention during GPU initialization
