...
\author{\uppercase{Guangtao Huang}\authorrefmark{1}}
...
\markboth
{Huang: ARMOR: A Reliable and Numerically Stable Framework for RL Post-Training of LLMs}
{Huang: ARMOR: A Reliable and Numerically Stable Framework for RL Post-Training of LLMs}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{author1.png}}]{Guangtao Huang}
