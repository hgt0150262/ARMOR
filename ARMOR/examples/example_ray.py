"""
Example demonstrating Ray distributed training in ARMOR.
"""

import torch
import numpy as np

from ARMOR.ray_worker import (
    Role,
    RayResourcePool,
    ResourcePoolManager,
    RayWorkerGroup,
...
if __name__ == "__main__":
    print("="*60)
    print("ARMOR - Ray Distributed Training Examples")
    print("="*60)
